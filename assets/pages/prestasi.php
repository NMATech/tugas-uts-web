    ...
    <div class="flex flex-col w-[100%]">
        ...
        <div class="flex flex-col md:flex-row w-full">
            <div class="w-full order-first md:w-44 lg:w-64 md:flex-none border border-r-slate-700">
                <div class="bg-white w-full md:h-screen p-3 overflow-y-auto">
                    <ul class="flex flex-col justify-start items-center md:items-start">
                        ...
                        <a href="portofolio.php" class="w-full">
                            <li
                                class="flex justify-center md:justify-start items-center rounded text-gray-900 p-2 mt-2 hover:bg-[#E72929] hover:text-white cursor-pointer text-center md:text-left">
                        ...
                        <a href="" class="w-full">
                            <li class="flex justify-center md:justify-start items-center rounded p-2 mt-2 bg-[#E72929] text-white cursor-pointer text-center md:text-left"
                                id="prestasiNav">
            ...
            <div class="bg-slate-100 flex-1">
                <h1 class="m-2 font-bold text-xl md:text-2xl lg:text-3xl animate__animated animate__backInLeft">
                    Prestasi / Pencapaian
                </h1>
                ...
                <div class="flex flex-col justify-center items-center">
                    <div class="flex flex-col justify-center items-center">
                        <div class="mt-2">
                            <img src="../img/narihakri.png" alt="" class="w-[250px] md:w-[30rem]">
                        </div>
                        <div class="text-center">
                            <h1 class="font-bold text-xl md:text-2xl">Ex. Participant Hackfest 2023/2024</h1>
                        </div>
                    </div>
                    <div class="flex flex-col justify-center items-center">
                        <div class="mt-3">
                            <img src="../img/image (5).png" alt="" class="w-[250px] md:w-[30rem]">
                        </div>
                        <div class="text-center">
                            <h1 class="font-bold text-xl md:text-2xl">Dicoding Dasar Pemrogramman Web</h1>
                        </div>
                    </div>
                    <div class="flex flex-col justify-center items-center">
                        <div class="mt-3">
                            <img src="../img/image (6).png" alt="" class="w-[250px] md:w-[30rem]">
                        </div>
                        <div class="text-center">
                            <h1 class="font-bold text-xl md:text-2xl">Dicoding Logic 101</h1>
                        </div>
                    </div>
                    <div class="flex flex-col justify-center items-center">
                        <div class="mt-3">
                            <img src="../img/image (7).png" alt="" class="w-[250px] md:w-[30rem]">
                        </div>
                        <div class="text-center">
                            <h1 class="font-bold text-xl md:text-2xl">Dicoding Data 101</h1>
                        </div>
                    </div>
                    <div class="flex flex-col justify-center items-center">
                        <div class="mt-3">
                            <img src="../img/image (8).png" alt="" class="w-[250px] md:w-[30rem]">
                        </div>
                        <div class="text-center mb-2">
                            <h1 class="font-bold text-xl md:text-2xl">Dicoding Meniliti Karrier sebagai SoftDev</h1>
                        </div>
                    </div>
                </div>
            </div>
